...
function DashboardCard12({ queryResponse, activeClusterIndex }) {
  const [authors, setAuthors] = useState([])
  const [themes, setThemes] = useState([])
  useEffect(() => {
    if (queryResponse && activeClusterIndex !== null) {
      setAuthors(queryResponse[activeClusterIndex].similar.authors);
      setThemes(queryResponse[activeClusterIndex].similar.themes)
    }
  }, [activeClusterIndex])
  ...
  return (
    <div className="col-span-full xl:col-span-6 bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700">
      <header className="px-5 py-4 border-b border-slate-100 dark:border-slate-700">
        <h2 className="font-semibold text-slate-800 dark:text-slate-100">Similarities</h2>
      </header>
      <div className="p-3">
        {/* Card content */}
        {/* "Today" group */}
        <div>
          ...
          <ul className="my-1">
            {authors.map((author, idx) => {
              return(
                <li key={idx} className="flex px-2">
                  ...
                  <div className="grow flex items-center border-b border-slate-100 dark:border-slate-700 text-sm py-2">
                    <div className="grow flex justify-between">
                      <div className="self-center">
                        ...
                        is a common author in this cluster.
                      </div>
              ...
              return (
                <li key={idx} className="flex px-2">
                  ...
                  <div className="grow flex items-center border-b border-slate-100 dark:border-slate-700 text-sm py-2">
                    ...
                    is a common theme in this cluster.
                  </div>
                  <div className="shrink-0 self-end ml-2">
                    <a className="font-medium text-indigo-500 hover:text-indigo-600 dark:hover:text-indigo-400" href="#0">
                      View<span className="hidden sm:inline"> -&gt;</span>
